{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-da31017e-d757-4e79-80e6-531b85087541" = [ ];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (Colemak-DH Wide)" = [ ];
      ...
      "plasma-manager-commands.desktop"."launch-wezterm" = "Meta+Return";
      ...
      "services/plasma-manager-commands.desktop"."launch-wezterm" = "Meta+Return";
    };
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."da31017e-d757-4e79-80e6-531b85087541" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "da31017e-d757-4e79-80e6-531b85087541";
      "kcminputrc"."Keyboard"."RepeatDelay" = 250;
      "kcminputrc"."Keyboard"."RepeatRate" = 45;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."ScrollFactor" = 2;
      ...
      "kdeglobals"."WM"."activeBackground" = "30,30,32";
      "kdeglobals"."WM"."activeBlend" = "255,255,255";
      "kdeglobals"."WM"."activeForeground" = "170,170,172";
      "kdeglobals"."WM"."inactiveBackground" = "30,30,32";
      "kdeglobals"."WM"."inactiveBlend" = "154,169,200";
      "kdeglobals"."WM"."inactiveForeground" = "120,120,122";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{2f250556-9093-426c-82cd-c5d22cea202f}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{b66c9a7c-8351-488f-8938-cefe798f36d0}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{0a2110ea-982a-42a7-9f25-6588f5b3af58}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{ca9a4f8c-56fb-4f12-a50e-9c007ba8746e}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{1c0612fc-0cce-4a2b-a3e3-c4d025ee587b}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{395d4560-29c7-4abb-9f31-b1ac488ca08f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{28f857c7-3700-47ad-a107-7d6b4c221f86}";
      ...
      "kwinrc"."Desktops"."Id_1" = "3f86d7fd-be89-4196-b279-bf3fe0160f06";
      "kwinrc"."Desktops"."Id_2" = "4cf5ec31-91a9-4a47-a294-06d6734d90ed";
      "kwinrc"."Desktops"."Id_3" = "daa53f4b-d708-490d-ac05-5aef621cb762";
      "kwinrc"."Desktops"."Id_4" = "fc2689db-2694-4a8f-b31d-df2d79fd28fa";
      "kwinrc"."Desktops"."Name_1" = "Work";
      "kwinrc"."Desktops"."Name_2" = "Web";
      "kwinrc"."Desktops"."Name_3" = "Communication";
      "kwinrc"."Desktops"."Name_4" = "Music";
      ...
      "kwinrc"."Tiling/00072d4c-51db-5e54-9b8c-e8a6e4d2fcea"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/d74d439a-fac8-58a7-ae6b-e6397e9a5641"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1.5;
      "kxkbrc"."Layout"."DisplayNames" = ",";
      "kxkbrc"."Layout"."LayoutList" = "us,us";
      "kxkbrc"."Layout"."Use" = true;
      "kxkbrc"."Layout"."VariantList" = "colemak_dh_wide,";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Theme"."name" = "AppleDark-ALL-AccentDinamic";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/ryan/Pictures/wallpapers/65ad6ffbb9187368a08b9457_treescapes-I-15.jpg,/home/ryan/Pictures/wallpapers/macOS-Monterey-wallpaper-Dark.jpg,/home/ryan/Pictures/wallpapers/macOS-Monterey-wallpaper-Light.jpg";
