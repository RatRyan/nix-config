{ inputs, ... }: {
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."da31017e-d757-4e79-80e6-531b85087541".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "da31017e-d757-4e79-80e6-531b85087541";
      "kcminputrc"."Keyboard"."RepeatDelay".value = 250;
      "kcminputrc"."Keyboard"."RepeatRate".value = 45;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."ClickMethod".value = 2;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."NaturalScroll".value = true;
      "kcminputrc"."Libinput/1267/12814/ELAN0687:00 04F3:320E Touchpad"."ScrollFactor".value = 2;
      ...
      "kdeglobals"."General"."LastUsedCustomAccentColor".value = "104,107,111";
      ...
      "kdeglobals"."WM"."inactiveBackground".value = "30,30,32";
      "kdeglobals"."WM"."inactiveBlend".value = "154,169,200";
      "kdeglobals"."WM"."inactiveForeground".value = "120,120,122";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{2f250556-9093-426c-82cd-c5d22cea202f}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{b66c9a7c-8351-488f-8938-cefe798f36d0}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{0a2110ea-982a-42a7-9f25-6588f5b3af58}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{ca9a4f8c-56fb-4f12-a50e-9c007ba8746e}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{1c0612fc-0cce-4a2b-a3e3-c4d025ee587b}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{395d4560-29c7-4abb-9f31-b1ac488ca08f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{28f857c7-3700-47ad-a107-7d6b4c221f86}";
      ...
      "kwinrc"."Desktops"."Id_1".value = "3f86d7fd-be89-4196-b279-bf3fe0160f06";
      "kwinrc"."Desktops"."Id_2".value = "4cf5ec31-91a9-4a47-a294-06d6734d90ed";
      "kwinrc"."Desktops"."Id_3".value = "daa53f4b-d708-490d-ac05-5aef621cb762";
      "kwinrc"."Desktops"."Id_4".value = "fc2689db-2694-4a8f-b31d-df2d79fd28fa";
      "kwinrc"."Desktops"."Name_1".value = "Work";
      "kwinrc"."Desktops"."Name_2".value = "Web";
      "kwinrc"."Desktops"."Name_3".value = "Communication";
      "kwinrc"."Desktops"."Name_4".value = "Music";
      "kwinrc"."Desktops"."Number".value = 4;
      "kwinrc"."Desktops"."Rows".value = 1;
      "kwinrc"."Effect-overview"."BorderActivate".value = 9;
      "kwinrc"."Effect-slide"."HorizontalGap".value = 0;
      "kwinrc"."Effect-slide"."SlideBackground".value = false;
      ...
      "plasmarc"."Theme"."name".value = "AppleDark-ALL-AccentDinamic";
      "plasmarc"."Wallpapers"."usersWallpapers".value = "/home/ryan/Pictures/wallpapers/65ad7072fca1848ff58a5d55_treescapes-I-03.jpg";
