{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-0cd2993e-5f68-4a2d-bf63-0e89aeabf9e1" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."0cd2993e-5f68-4a2d-bf63-0e89aeabf9e1" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "0cd2993e-5f68-4a2d-bf63-0e89aeabf9e1";
      ...
      "kdeglobals"."General"."AccentColor" = "38,65,222";
      "kdeglobals"."General"."LastUsedCustomAccentColor" = "38,65,222";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 171;
      "kdeglobals"."KFileDialog Settings"."View Style" = "DetailTree";
      "kdeglobals"."WM"."activeBackground" = "25,25,25";
      "kdeglobals"."WM"."activeBlend" = "255,255,255";
      "kdeglobals"."WM"."activeForeground" = "239,240,241";
      "kdeglobals"."WM"."inactiveBackground" = "25,25,25";
      "kdeglobals"."WM"."inactiveBlend" = "65,65,65";
      "kdeglobals"."WM"."inactiveForeground" = "131,131,131";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{22737466-00ed-4194-b6a6-f1c17f8a57c9}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{ea91b8a4-794f-4f4d-b6d2-9a923c5bf26f}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{168c55f4-9930-4571-94c5-92af76eafc09}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{01a784d2-cf68-49b1-9a28-b1fab06f2adc}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{4ee811f3-f362-4ea4-8baf-08c10526c556}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{02fa9126-a9d8-46cf-bdb1-dcc334323a4f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{a7d233ca-fe0e-4360-90a1-5b9e7fe7a340}";
      ...
      "kscreenlockerrc"."Greeter"."Wallpaper"."org.kde.image"."General"."Image" = "/home/ryan/Downloads/wp12329533-nixos-wallpapers.png";
      "kscreenlockerrc"."Greeter"."Wallpaper"."org.kde.image"."General"."PreviewImage" = "/home/ryan/Downloads/wp12329533-nixos-wallpapers.png";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "217bb1ed-c986-4445-80ab-a2754bd98895";
      "kwinrc"."Desktops"."Id_2" = "b14789b8-7d3f-4fce-9fc3-953a332bd639";
      "kwinrc"."Desktops"."Number" = 2;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling"."1ffd261d-a4b6-5259-8309-65b38833f749"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling"."3278669f-b5fc-523f-b2e6-313ac6df5207"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling"."81e003b1-2657-5c78-8902-90d3dc562df2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling"."8d50ad96-53b5-592f-88c7-c9d08822b4b8"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling"."a90f3615-5213-52a6-9022-81a722cb5d3a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling"."d8e14c54-b772-5bbd-8892-4afd37f8be28"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/ryan/Downloads/wp12329533-nixos-wallpapers.png,/home/ryan/Downloads/NESF3W7.jpeg";
    };
  };
}
